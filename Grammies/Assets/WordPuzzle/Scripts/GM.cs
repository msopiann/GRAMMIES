...
public class GM : MonoBehaviour
{
	...
	int CheckForEmptyCells(int i, int j, int rorc, string word)
	{
		...
		if (rorc == 0)
		{  // o Mean row and 1 mean coloum//ROW  MEAN I SAME AND J CHANGES 
	...
	void CheckEachAndPut() //check each word and put it in the Grid
	{
		...
		while (Tries < 2000)
		{ //Try For N Times To Put each WOrd If Possible
			...
			foreach (var item in Words)
			{
				...
				{ //Mean Coloumn Selected TO put Word
					while (true)
					{
						...
						{ //Random I means start putting Word in Random Cell
							break;
